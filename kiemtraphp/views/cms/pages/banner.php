...
<h1 class="h3 mb-2 text-gray-800 d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="modal fade" id="addBanner" tabindex="-1" role="dialog" aria-labelledby="addBannerModal" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <form method="POST" action="http://localhost/kiemtraphp/controller/cms/Banner.php" enctype="multipart/form-data">
...
<script>
  function deleteBanner(id){
    $.post( "http://localhost/kiemtraphp/controller/cms/banner.php",{id:id,action:"delete"}, function( data ) {
      // console.log(data);
  ...
  function editBanner(id){
    $.post( "http://localhost/kiemtraphp/controller/cms/banner.php",{id:id,action:"view-edit"}, function( data ) {
