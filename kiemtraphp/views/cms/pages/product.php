  ...
  <h1 class="h3 mb-2 text-gray-800 d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="modal fade" id="addProduct" tabindex="-1" role="dialog" aria-labelledby="addProductModal" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <form method="POST" action="http://localhost/kiemtraphp/controller/cms/product.php" enctype="multipart/form-data">
...
<script>
  function deleteProduct(id) {
    $.post("http://localhost/kiemtraphp/controller/cms/product.php", {
      id: id,
      action: "delete"
    }, function(data) {
      // console.log(data);
