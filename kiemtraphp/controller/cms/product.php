...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  if($action == 'add'){
    ...
    $url_target = 'http://localhost/kiemtraphp/upload/product/';
    ...
    if(getimagesize($_FILES["image"]["tmp_name"])){
      $extension = pathinfo($_FILES["image"]["name"], PATHINFO_EXTENSION); $file_name_image = time().".".$extension;
    ...
    echo '<form method="POST" action="http://localhost/kiemtraphp/controller/cms/product.php" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addProductModal">Edit Product</h5>
