...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  if($action == 'add'){
    ...
    $url_target = 'http://localhost/kiemtraphp/upload/banner/';
    ...
    echo '<form method="POST" action="http://localhost/kiemtraphp/controller/cms/Banner.php" enctype="multipart/form-data">
