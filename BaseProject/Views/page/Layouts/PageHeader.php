            ...
            <div class="">
                <div class="">
                    <ul class="top-bar-link top-bar-link-right dot">
                        <?php if (!$user) { ?>
                            <li><a href="http://localhost/BaseProject/Views/page/Login.php">Sign in</a></li>
                            <li><a href="http://localhost/BaseProject/Views/page/Login.php">Sign up</a></li>
                        <?php
                        } else {
                            ...
                            <li class="dropdown-item">
                                <form method="post" action="http://localhost/BaseProject/Controllers/User.php">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="logo text-center">
                                <a href="http://localhost/BaseProject/Views/page/Home.php">
                                    <img src="../../vendor/frontend/images/logo_white.png" alt="Logo" style="height: 100px ; margin: -20px -10px">
                                    <h2 style="color: white; display: inline-block">Webbanhangthi</h2>
                                </a>
                            </div>
                        </div>
                        <div id="search_form" class="col-sm-6 col-md-7 col-lg-6 col-xs-12">
                            ...
                            <div class="box-radius advanced-search">
                                <form class="form-inline" method="get" action="http://localhost/BaseProject/Views/page/Search.php">
                        ...
                        <div class="col-lg-2 col-md-2  col-sm-2 col-xs-12  left_bar_icon" style="justify-content: space-around; display: flex;">
                            ...
                            <div class="block-wrap-cart ">
                                <div class="">
                                    <a href="http://localhost/BaseProject/Views/page/Cart.php" class="fa fa-shopping-cart shopping_icon not0">
